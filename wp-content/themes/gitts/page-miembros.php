...
$members_img = get_template_directory_uri() . '/assets/img/team/members';
?>
...
<section class="py-14 bg-white">
    <div class="max-w-3xl mx-auto px-6 text-center">
        ...
        ?>
            <p class="text-slate-600 text-base leading-relaxed">GITTS está conformado por un equipo multidisciplinario de investigadores, estudiantes y colaboradores que comparten una visión común: impulsar el conocimiento y la innovación en telecomunicaciones y procesamiento de señales. Conozca a los miembros del grupo, los estudiantes que participan activamente en nuestros proyectos y las instituciones y socios que colaboran en el desarrollo de nuestras iniciativas científicas y tecnológicas.</p>
        <?php endif; ?>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <?php endif; ?>
                <h3 class="text-base font-bold text-slate-800 tracking-wide mb-3"><?php echo strtoupper(get_the_title()); ?></h3>
            ...
            <div class="card bg-white border border-slate-200">
                <div class="card-body p-8">
                    <div class="flex gap-5 items-start">
                        <?php if (has_post_thumbnail()) : ?>
                            <?php the_post_thumbnail('thumbnail', ['class' => 'w-20 h-20 rounded-full object-cover flex-shrink-0']); ?>
                        <?php else : ?>
                            <div class="w-20 h-20 rounded-full bg-slate-200 flex items-center justify-center flex-shrink-0">
                                <span class="text-2xl font-light text-slate-500"><?php echo mb_substr(get_the_title(), 0, 1); ?></span>
                            </div>
                        <?php endif; ?>
                        <div>
                            <h3 class="text-sm font-bold text-slate-800 tracking-wide mb-1"><?php echo strtoupper(get_the_title()); ?></h3>
                            <?php if ($cargo) : ?>
                                <p class="text-slate-500 text-sm"><?php echo esc_html($cargo); ?></p>
                            <?php endif; ?>
                            <?php if ($bio) : ?>
                                <p class="text-slate-500 text-xs leading-relaxed mb-2"><?php echo esc_html($bio); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-8">
                    <div class="flex gap-5 items-start">
                        ...
                        <div>
                            ...
                            <?php endif; ?>
                            <?php if ($bio) : ?>
                                <p class="text-slate-500 text-xs leading-relaxed"><?php echo esc_html($bio); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            if ($egresados->have_posts()) :
                while ($egresados->have_posts()) : $egresados->the_post();
                    $bio = get_post_meta(get_the_ID(), 'bio_extendida', true);
            ?>
            <div class="flex gap-3 items-start p-5 bg-slate-50 rounded-xl">
