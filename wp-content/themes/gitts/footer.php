...
<footer class="footer footer-gradient text-slate-200 p-14 mt-auto">
    <aside>
        <div class="flex items-center gap-3 mb-3">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/brand/logo-digital.png" alt="GITTS" class="h-10 w-auto">
            <span class="text-white font-semibold text-lg tracking-tight">GITTS</span>
        </div>
    ...
    <nav>
        ...
        <a href="<?php echo home_url('/quienes-somos'); ?>" class="link link-hover text-sm text-slate-300 hover:text-white">¿Quiénes somos?</a>
        <a href="<?php echo home_url('/investigacion'); ?>" class="link link-hover text-sm text-slate-300 hover:text-white">Investigación</a>
        <a href="<?php echo home_url('/infraestructura'); ?>" class="link link-hover text-sm text-slate-300 hover:text-white">Infraestructura</a>
        <a href="<?php echo home_url('/produccion-cientifica'); ?>" class="link link-hover text-sm text-slate-300 hover:text-white">Producción científica</a>
        <a href="<?php echo home_url('/miembros'); ?>" class="link link-hover text-sm text-slate-300 hover:text-white">Nuestro equipo</a>
        <a href="<?php echo home_url('/noticias'); ?>" class="link link-hover text-sm text-slate-300 hover:text-white">Actualidad</a>
    </nav>
    <nav>
...
<footer class="footer footer-center bg-[#0E3A5F] text-slate-400 border-t border-white/5 p-4">
